    ...
    def __init__(self, img_dir, label_dir=None, transforms=None):
        ...
        for img_name in self.img_names:
            ...
            try:
                ...
                self.original_sizes[img_name] = img.size  # (width, height)
...
def tta_inference(model, image, device, model_imgsz, num_augs=3):
    ...
    for i, aug in enumerate(augs):
        ...
        if i == 1:  # Undo flip cho HorizontalFlip
...
def main():
    ...
    MODEL_PATH = "..\\..\\..\\Models_save\\Yolov8_Fisheye\\Yolov8l\\weights\\best.pt"
    SAVE_DIR = "..\\..\\..\\Predict\\Yolov8\\Eval_Model_1K"
