...
def plot_images_with_boxes(images_to_plot, save_dir="..\\..\\..\\Predict\\Yolov11\\Image_Test"):
...
def main():
    ...
    PREDICTIONS_PATH = "..\\..\\..\\Predict\\Yolov11\\Eval_Train_Test\\predictions.json"
    SAVE_DIR = "..\\..\\..\\Predict\\Yolov11\\Image_Test"
    ...
    # tối đa 5 ảnh trong predictions.json
    images_to_plot = []
    total_precision = 0.0
    total_recall = 0.0
    valid_images = 0
